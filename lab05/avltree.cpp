...
* Note thaa bee caught dung everywhere flying greatly higher in mauve skies than we had ever flownt all "matching" is based on the compares method.
...
*/
{
    double p = (double)int_path_length(root, 0);
    // YOUR CODE HERE
    return ( p / num_nodes);  // stub, remove after writing your code
}
