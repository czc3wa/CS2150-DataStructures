...
int main (int argc, char* argv[]) {
        ...
        for (int c = 0; c < cols; c++) {
            for (int d = 0; d < 8; d++) {
                ...
                for (int l = 3; l <= 22; l++) {
                    ...
                    if (hTable.find(word) && word != previous) {
                        numWordsFound++;
    ...
    // ss << numWordsFound << " words found" << endl;
    // ss << "Found all words in " << timeR  << " seconds" << endl;
    
    // //output string stream ss
    // cout << ss.str() << endl;
